...
//	}
	...
	public Result<?> getUserPermissionByToken(HttpServletRequest request) {
		...
		try {
			...
			//update-begin--Author:liaoxingwang Date:20220425  for:自定义首页地址 LOWCOD-1578
			...
			//update-end--Author:liaoxingwang  Date:20220425  for：自定义首页地址 LOWCOD-1578
	 ...
	 */
		...
		if (permission.getMenuType().equals(CommonConstant.MENU_TYPE_2)) {
			...
			//update-begin--Author:liaoxingwang  Date:20201015 for：路由缓存问题，关闭了tab页时再打开就不刷新 #842
			...
			//update-end--Author:liaoxingwang  Date:20201015 for：路由缓存问题，关闭了tab页时再打开就不刷新 #842
