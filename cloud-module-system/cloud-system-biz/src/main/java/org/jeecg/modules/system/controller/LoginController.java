...
public class LoginController {
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel){
		...
		//update-begin--Author:liaoxingwang  Date:20190805 for：暂时注释掉密码加密逻辑，有点问题
		//前端密码加密，后端进行密码解密
	...
	public Result<JSONObject> getUserInfo(HttpServletRequest request){
		...
		if(oConvertUtils.isNotEmpty(username)) {
			...
			//update-begin---author:liaoxingwang ---date:2022-06-20  for：vue3前端，支持自定义首页-----------
			...
			//update-begin---author:liusq ---date:2022-06-29  for：接口返回值修改，同步修改这里的判断逻辑-----------
			//update-end---author:liaoxingwang ---date::2022-06-20  for：vue3前端，支持自定义首页--------------
	...
	public Result<String> sms(@RequestBody JSONObject jsonObject) {
		...
		try {
			...
			//update-begin--Author:liaoxingwang  Date:20190812 for：issues#391
			//result.setResult(captcha);
			//update-end--Author:liaoxingwang  Date:20190812 for：issues#391
