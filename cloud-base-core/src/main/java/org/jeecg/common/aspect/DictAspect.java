...
public class DictAspect {
    ...
    private Object parseDictText(Object result) {
        if (result instanceof Result) {
            if (((Result) result).getResult() instanceof IPage) {
                ...
                //update-begin--Author:liaoxingwang -- Date:20220606 ----for：【VUEN-1230】 判断是否含有字典注解,没有注解返回-----
                ...
                //update-end--Author:liaoxingwang -- Date:20220606 ----for：【VUEN-1230】 判断是否含有字典注解,没有注解返回-----
                for (Object record : records) {
                    String json="{}";
                    try {
                        //update-begin--Author:liaoxingwang -- Date:20220531 ----for：【issues/#3629】 DictAspect Jackson序列化报错-----
                        //解决@JsonFormat注解解析不了的问题详见SysAnnouncement类的@JsonFormat
                         json = objectMapper.writeValueAsString(record);
                        //update-end--Author:liaoxingwang -- Date:20220531 ----for：【issues/#3629】 DictAspect Jackson序列化报错-----
                    } catch (JsonProcessingException e) {
                        log.error("json解析失败"+e.getMessage(),e);
                    }
                    //update-begin--Author:liaoxingwang -- Date:20211223 ----for：【issues/3303】restcontroller返回json数据后key顺序错乱 -----
                    JSONObject item = JSONObject.parseObject(json, Feature.OrderedField);
                    //update-end--Author:liaoxingwang -- Date:20211223 ----for：【issues/3303】restcontroller返回json数据后key顺序错乱 -----

                    //update-begin--Author:liaoxingwang -- Date:20190603 ----for：解决继承实体字段无法翻译问题------
                    ...
                    //update-end--Author:liaoxingwang  -- Date:20190603 ----for：解决继承实体字段无法翻译问题------
    ...
    private String translateDictValue(String code, String text, String table, String key) {
        ...
        for (String k : keys) {
            ...
            //update-begin--Author:liaoxingwang -- Date:20210531 ----for： !56 优化微服务应用下存在表字段需要字典翻译时加载缓慢问题-----
            if (!StringUtils.isEmpty(table)){
            ...
            //update-end--Author:liaoxingwang -- Date:20210531 ----for： !56 优化微服务应用下存在表字段需要字典翻译时加载缓慢问题-----
