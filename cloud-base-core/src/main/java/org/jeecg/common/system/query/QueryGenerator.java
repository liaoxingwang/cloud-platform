...
public class QueryGenerator {
	...
	private static void doMultiFieldsOrder(QueryWrapper<?> queryWrapper,Map<String, String[]> parameterMap, Map<String,String> fieldColumnMap) {
		...
		//update-begin-author:liaoxingwang date:2022-11-07 for:避免用户自定义表无默认字段{创建时间}，导致排序报错
		...
		//update-end-author:liaoxingwang date:2022-11-07 for:避免用户自定义表无默认字段{创建时间}，导致排序报错
		...
		if (oConvertUtils.isNotEmpty(column) && oConvertUtils.isNotEmpty(order)) {
			...
			//update-begin-author:liaoxingwang date:2022-10-10 for:【jeecg-boot/issues/I5FJU6】doMultiFieldsOrder() 多字段排序方法存在问题
			...
			//update-end-author:liaoxingwang date:2022-10-10 for:【jeecg-boot/issues/I5FJU6】doMultiFieldsOrder() 多字段排序方法存在问题

			//SQL注入check
			SqlInjectionUtil.filterContent(column);

			//update-begin--Author:liaoxingwang  Date:20210531 for：36 多条件排序无效问题修正-------
			// 排序规则修改
			...
			//update-end--Author:liaoxingwang  Date:20210531 for：36 多条件排序无效问题修正-------
		}
	}
	...
	public static QueryRuleEnum convert2Rule(Object value) {
		...
		//update-begin--Author:liaoxingwang  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284-------------------
		...
		//update-end--Author:liaoxingwang  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284---------------------
