        ...
        for (int i = 0; i < array.size(); i++) {
            ...
            if (predicates != null) {
                ...
                for (Object map : list) {
                    ...
                    //update-begin-author:liaoxingwang date:20220419 for:【VUEN-762】路由条件添加异常问题,原因是部分路由条件参数需要设置固定key
                    ...
                    //update-end-author:liaoxingwang date:20220419 for:【VUEN-762】路由条件添加异常问题,原因是部分路由条件参数需要设置固定key
